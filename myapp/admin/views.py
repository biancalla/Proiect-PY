...
def edit_department(id):
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('admins.list_departments'))
...
def delete_role(id):
    ...
    # redirect to the roles page
    return redirect(url_for('admins.list_roles'))
...
def assign_employee(id):
    """
    Assign a department, a role and a paygrade to an employee
    """
    check_admin()
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('You have successfully assigned a department, role and salary.')
...
def delete_employee(id):
    ...
    return render_template('admin/employees/employee.html', employee=employee, form=form,
...
def add_grade():
    ...
    if form.validate_on_submit():
        ...
        try:
            # add pay grade to the database
            db.session.add(grade)
            db.session.commit()
            flash('You have successfully added a new pay grade.')

        except:
            # in case pay grade already exists
